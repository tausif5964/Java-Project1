...
import java.sql.*;
public class E_TC implements ActionListener {
    JFrame M = new JFrame();
    ...
    JPanel backgroundPanel = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            ImageIcon imageIcon = new ImageIcon("D:/pictures/Anjuman/E_TC.gif");
    ...
    public E_TC() {
        M.setTitle("Electronics and Tele-Communication");
    ...
    String[][] insertTable() {
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM Staff_detail WHERE Working_branch = 'Electronics and Telecommunication';");
    ...
    String[][] getSyllabusForSemester() {
        try {
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/college", "root", "");
            Statement stmt = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            ResultSet rs = stmt.executeQuery("SELECT * FROM Syllabus WHERE branch_name = 'Electronics and Telecommunication';");
