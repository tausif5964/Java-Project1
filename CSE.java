...
public class CSE implements ActionListener {
    ...
    JPanel backgroundPanel = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            ImageIcon imageIcon = new ImageIcon("D:/pictures/Anjuman/CSE.gif");
    ...
    public CSE() {
        M.setTitle("Computer Science and Engineering");
    ...
    String[][] insertTable() {
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM Staff_detail WHERE Working_branch = 'Computer Science and Engineering';");
    ...
    String[][] getSyllabusForSemester() {
        try {
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/college", "root", "");
            Statement stmt = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            ResultSet rs = stmt.executeQuery("SELECT * FROM Syllabus WHERE branch_name = 'Computer Science and Engineering';");
