...
import java.sql.*;
public class Chemical implements ActionListener {
    JFrame M = new JFrame();
    ...
    JPanel backgroundPanel = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            ImageIcon imageIcon = new ImageIcon("D:/pictures/Anjuman/Chemical image.gif");
    ...
    public Chemical() {
        M.setTitle("Chemical Engineering");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnSyllabus) {
            String column1[] = {"Branch Naame", "Semester", "Syllabus Details"};
    ...
    String[][] insertTable() {
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT Employee_id, Employee_name, Education, Working_branch, year_of_experience FROM Staff_detail WHERE Working_branch = 'Chemical Engineering';");
