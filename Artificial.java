...
import java.sql.*;
public class Artificial implements ActionListener {
    JFrame M = new JFrame();
    ...
    JPanel backgroundPanel = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            ImageIcon imageIcon = new ImageIcon("D:/pictures/Anjuman/Data Science.gif");
    ...
    public Artificial() {
        M.setTitle("Artificial intelligence and Data Science");
    ...
    String[][] insertTable() {
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM Staff_detail WHERE Working_branch = 'Artificial intelligence and Data science';");
    ...
    String[][] getSyllabusForSemester() {
        try {
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/college", "root", "");
            Statement stmt = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            ResultSet rs = stmt.executeQuery("SELECT * FROM Syllabus WHERE branch_name = 'Artificial intelligence and Data science';");
